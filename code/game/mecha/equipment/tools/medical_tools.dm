...
/obj/item/mecha_parts/mecha_equipment/medical/sleeper/Exit(go/O)
	return 0
...
/obj/item/mecha_parts/mecha_equipment/medical/syringe_gun/action(go/target)
	if(!action_checks(target))
		return

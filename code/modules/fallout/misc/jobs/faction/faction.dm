...
/datum/f13_faction/punk
	...
	description = "<b>Alignment: Chaotic Evil</b><br>Punks - Any group of wastelanders who pillage, plunder, murder, or otherwise ruin the day of anyone unfortunate enough to not be one of them.<br>Raiders tend to organize into loose confederations of gangs in the post-apocalyptic wasteland, and of them, the punks are a constant problem.<br>Punks typically prey upon travelers and very small towns, leaving more populous or larger areas alone."
	verbs = list(/mob/proc/begin_head_voting)
